...
Links principais: [Política de release](release-policy.md) | [Plano da versão alfa](alpha-version-plan.md) | [Notas preliminares da futura alfa](release-notes-alpha.md) | [Prontidão para alfa pública](public-alpha-readiness.md) | [Diagnóstico local de prontidão alfa](alpha-readiness-diagnostic.md) | [Execução local do checklist pré-tag](pre-tag-checklist-execution.md) | [Consolidação local do candidato alfa](alpha-candidate-summary.md) | [Validação de instalação limpa](clean-install-validation.md) | [CHANGELOG.md](../../CHANGELOG.md) | [CONTRIBUTING.md](../../CONTRIBUTING.md)
...
A consolidação local do candidato alfa em [alpha-candidate-summary.md](alpha-candidate-summary.md) é evidência preparatória adicional. Ela não transforma este checklist em autorização automática e não remove os gates manuais.
...
- [ ] Consolidação local do candidato alfa em [alpha-candidate-summary.md](alpha-candidate-summary.md) revisada como evidência preparatória, sem tratar a consolidação como autorização automática.

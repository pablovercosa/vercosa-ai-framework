...
- `audit/` define contratos iniciais, implementação em memória e helpers opcionais para eventos de decisões Policy, Guardian e Context, sem persistência externa ou integração obrigatória com módulos consumidores nesta etapa.
